...
const FashionMerchandiser = () => {
  return (
    <>
    <Header/>
    <div style={{ padding: "60px 30px",marginTop: "10rem", maxWidth: 1200, margin: "auto", backgroundColor: "#fff" }}>
      <motion.div 
        initial="hidden" 
        animate="visible" 
      ...
      >
        ...
        <Row gutter={[32, 32]}>
          ...
          <Col xs={24}>
            ...
            >
              <Card
                title={<span style={{ fontSize: "24px" }}>Types of Fashion Merchandisers</span>}
                style={cardStyle}
                headStyle={{ 
                  backgroundColor: "#FF8C00", 
                  color: "#fff",
